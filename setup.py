...
setup(
    name='cloudbitsgo',
    version=get_version(),
    description='Migrate files and create symbolic links from src to dest',
    url='https://github.com/eduardocerqueira/cloudbitsgo.git',
    ...
    entry_points={'console_scripts': ['cloudbitsgo=cloudbitsgo.__init__:main']}
)
